...
```bash
git clone https://github.com/NightAxolotlContinue/recomby-geo-268.git
cd recomby-geo-268
python setup.py
```
...
| Skill | 来源 | 用途 |
|-------|------|------|
| `seo-geo-optimizer` | [199-biotechnologies](https://github.com/NightAxolotlContinue/recomby-geo-268) (MIT) | 主力，13 个 Python 脚本 |
...
<!-- Last updated: 2026-06-06 16:41:41 -->
